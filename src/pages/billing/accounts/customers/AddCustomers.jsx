        ...
        <div className="col-lg-12">
          <div className="form_element">
            <div className="form_title">
              <h5 className="title">Add Customers</h5>
            </div>
            <div className="form_content">
              <form action="" className="row gy-3 align-items-center justify-content-between">
                <div className="col-md-4">
                  ...
                  <input type="text" className="form-control" name="" id="" placeholder="Customer ID" />
                </div>
                <div className="col-md-4">
                  <label htmlFor="" className="form-label">
                    Customer Name
                  </label>
                  <input type="text" className="form-control" name="" id="" placeholder="Customer Name" />
                </div>
                <div className="col-md-4">
                  <label htmlFor="" className="form-label">
                    Email
